...
Se monto el LM35 en el centro de la hotbed, el control de encendido de la hotbed se hace mediante el relé que se aprecia a la derecha. Figura 3.

#### Figura 3:
![LM35 y hotbed](https://raw.githubusercontent.com/mattprofe/assets/master/filament_dryer/20240716_141932.jpg "LM35 y hotbed")

Al encender el sistema se enciende el led verde (Figura 4) y se envia el mensaje por uart (Figura 5). y queda a la espera de que se presione alguno de los botones para comenzar a trabajar.
...
Al presionar cualquiera de los botones, inicia el proceso de secado y cada 1 segundo parpadea el led de actividad, además se envia la temperatura actual, temperatura especificada, tiempo actual, tiempo especificado y estado de la hotbed. Figura 6.
...
Al mantener presionados ambos botones menos de 3 segundos, se cambia entre modo de selección de tiempo y temperatura, esto mientras el sistema esta secando. Figura 7.

#### Figura 7:
![Cambio de modo](https://raw.githubusercontent.com/mattprofe/assets/master/filament_dryer/20240716_142143.jpg "Cambio de modo")

Al mantener presionados ambos botones por 3 segundos o más, el sistema se detiene, informa por uart el evento y se restablece la temperatura y tiempo de secado, el sistema espera a que se presione un botón para volver a secar o que se apague. Figura 8.
...
Al alcanzar la/s hora/s de secado especificadas por el usuario, se envia por uart un aviso, se apaga la hotbed y el led de actividad se mantiene encendido, cada 10 segundos se emite un pitido y se queda a la espera de que se presione un botón para volver a secar o que se apague el sistema. Figura 9.
